...
<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="#"> Admin</a> 
                            ...
                            <div class="breadcrumb_divider"></div> 
                            <a class="" href="<c:out value="${pathMappings.getProperty('category')}"/>">Loại Sản Phẩm</a>
                            <div class="breadcrumb_divider"></div> 
                            ...
                            <div class="breadcrumb_divider"></div> 
                            <a class="current" href="<c:out value="${pathMappings.getProperty('cart')}"/>">Giỏ Hàng</a>
                            <div class="breadcrumb_divider"></div> 
                            <a class="" href="<c:out value="${pathMappings.getProperty('comment')}"/>">Bình Luận</a>
                            <div class="breadcrumb_divider"></div> 
                            <a class="current" >Quảng Cáo</a>
                            <div class="breadcrumb_divider"></div> 
